...
master_data = {
    ...
    'structure': {
        'boxes_per_pages': {
            ...
            'Bioengineering': 9,
            'Data Science': 6,
            'Chemical Engineering and Biotechnology': 8,
            'Civil Engineering': 8,
            'Communication Systems': 8,
            'Computational Science and Engineering': 8,
            'Computer Science': 8,
            'Digital Humanities': 7,
            'Electrical and Electronic Engineering': 8,
            'Energy Management and Sustainability': 7,
            'Environmental Sciences and Engineering': 7,
            'Financial Engineering': 7,
            'Life Sciences and Technology': 9,
            'Management, technology and entrepreneurship': 9,
            'Materials Science and Engineering': 9,
            'Mathematics': 7,
            'Mathematics for education (in French only)': 5,
            'Mechanical Engineering': 9,
            'Microengineering': 9,
            'Molecular and Biological Chemistry': 8,
            'Nuclear Engineering': 8,
            'Physics and Applied Physics': 8,
            'Double Diplomas and Joint Degrees': 1,
            "1:1 Master's EPFL-DTU": 7,
            'Double diploma EPFL-Polytechnique Montréal': 6,
            'Double Diploma EPFL-Centrale Lille': 6,
            'ENS de Lyon Informatique et Syscom': 7,
